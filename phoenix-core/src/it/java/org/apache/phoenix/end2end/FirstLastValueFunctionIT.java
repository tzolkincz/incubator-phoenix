...
public class FirstLastValueFunctionIT extends BaseHBaseManagedTimeIT {
	...
	public void unsignedLong() throws Exception {
		...
		ResultSet rs = conn.createStatement().executeQuery(
				"SELECT LAST_VALUE(\"value\", date) FROM firstValue GROUP BY page_id");
	...
	public void signedLongAsBigInt() throws Exception {
		...
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (1, 8, 1, 3)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (2, 8, 2, 7)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (3, 8, 3, 9)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (5, 8, 5, 158)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (4, 8, 4, 5)");
		conn.commit();
	...
	public void signedInteger() throws Exception {
		...
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (5, 8, 5, -255)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (1, 8, 1, 3)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (2, 8, 2, 7)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (3, 8, 3, 9)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (4, 8, 4, 4)");
	...
	public void unsignedInteger() throws Exception {
		...
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (3, 8, 3, 9)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (5, 8, 4, 2)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (4, 8, 5, 4)");
		conn.commit();
	...
	public void doubleDataType() throws Exception {
		...
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (1, 8, 1, 300)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (2, 8, 2, 7)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (3, 8, 3, 9)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (5, 8, 4, 2)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (4, 8, 5, 400)");
		conn.commit();
	...
	public void groupMultipleValues() throws Exception {
		...
		//second page_id
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (11, 9, 1, 3)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (12, 9, 2, 7)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (13, 9, 3, 9)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (15, 9, 4, 2)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (14, 9, 5, 40)");
	...
	public void nullValuesInAggregatingColumns() throws Exception {
		...
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date) VALUES (1, 8, 1)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date) VALUES (2, 8, 2)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date) VALUES (3, 8, 3)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date) VALUES (5, 8, 4)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date) VALUES (4, 8, 5)");
		conn.commit();
	...
	public void allColumnsNull() throws Exception {
		...
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id) VALUES (1, 8)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id) VALUES (2, 8)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id) VALUES (3, 8)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id) VALUES (5, 8)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id) VALUES (4, 8)");
		conn.commit();
	...
	public void inOrderByClausule() throws Exception {
		...
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (3, 8, 3, 9)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (5, 8, 4, 2)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (4, 8, 5, 5)");

		//second page
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (5, 2, 1, 3)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (6, 2, 2, 7)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (7, 2, 3, 9)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (8, 2, 4, 2)");
		conn.createStatement().execute("UPSERT INTO firstValue (id, page_id, date, \"value\") VALUES (9, 2, 5, 4)");

		conn.commit();

		ResultSet rs = conn.createStatement().executeQuery(
				"SELECT LAST_VALUE(\"value\", date), page_id FROM firstValue"
				+ " GROUP BY page_id ORDER BY LAST_VALUE(\"value\", date) DESC");
